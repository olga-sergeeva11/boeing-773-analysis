...
round(avg(load_pct), 2) as avg_load,
round(avg(lost_share_pct), 2) as avg_lost_share,
sum(lost_total) as lost_total_sum,
round(avg(lost_total), 2) as avg_lost_per_flight
from flight_analysis
group by 1,2
order by lost_total_sum desc;