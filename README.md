...
Это учебный аналитический проект на данных об авиаперевозках.

В нём я исследовала данные об авиаперевозках. Сначала я сравнила типы самолётов по вместимости, загрузке и выручке, а затем заметила, что у части рейсов Boeing 773 загрузка была аномально низкой. После этого я подробнее проанализировала эти рейсы и оценила масштаб потенциально упущенной выручки.

## Источник данных

В проекте использована демонстрационная база данных «Авиаперевозки» от Postgres Professional — набор `demo-medium`, дамп от 15.08.2017.

[Демонстрационная база данных «Авиаперевозки»](https://postgrespro.ru/education/demodb)
